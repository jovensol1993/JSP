...
<body>
	<form method="POST" action="/cls/project/noticeDetail.cls" id="detail"
		name="detail">
		<input type="hidden" name="nno2" id="nno2"> 
	</form>
	<form method="POST" action="/cls/project/noticeEditProc.cls" id="edit"
		name="edit">
		<input type="hidden" name="nno3" id="nno3"> 
	</form>
	<div class="w3-content mw800">
		...
		<div class="w3-col w3-margin-top w3-padding w3-card-4">
			...
			<div class="w3-col w3-border-left w3-border-right w3-margin-bottom">
				<form method="POST" action="/cls/project/noticeDelProc.cls" id="noticeDelProc" name="noticeDelProc">
					...
					<c:forEach var="data" items="${LIST}">
						<div class="w3-col w3-center w3-border-bottom" >
							...
							<div class="w3-col m1 w3-border-right w3-margin-top" style="font-size: 5pt">${data.ndate}</div>
							<div class="w3-col m1 w3-border-right w3-margin-top">${data.hits}</div>
							<div class="w3-btn w3-col m1 w3-border-right w3-margin-top delbtn" id="d${data.nno}">삭제</div>
							<div class="w3-btn w3-col m1 w3-border-right w3-margin-top editbtn" id="d${data.nno}">편집</div>
						</div>
					</c:forEach>
				</form>
			</div>
